 ...
 */
public class HttpGisException extends DealHttpException{

    public HttpGisException(String message, InvokeException cause) {
        super(message, cause);
    }

    public HttpGisException(InvokeException cause) {
        super(cause);
    }
